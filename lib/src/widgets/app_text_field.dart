...
class _AppTextFieldState extends State<AppTextField> {
  ...
  FormFieldValidator<String>? applyValidation() {
    if (widget.isValidationRequired.validate(value: true)) {
      if (widget.validator != null) {
        ...
        return (s) {
          if (s!.trim().isEmpty) return widget.errorThisFieldRequired.validate(value: errorThisFieldRequired);
          if (!s.trim().validateEmailEnhanced()) return widget.errorInvalidEmail.validate(value: 'Email is invalid');
          return null;
        };
  ...
  TextInputType? applyTextInputType() {
    ...
    } else if (widget.textFieldType == TextFieldType.EMAIL || widget.textFieldType == TextFieldType.EMAIL_ENHANCED) {
  ...
  Iterable<String>? applyAutofillHints() {
    if (widget.textFieldType == TextFieldType.EMAIL || widget.textFieldType == TextFieldType.EMAIL_ENHANCED) {
  ...
  Widget textFormFieldWidget() {
    return TextFormField(
      ...
      maxLines: widget.maxLines.validate(value: widget.textFieldType == TextFieldType.MULTILINE ? 10 : 1),
      minLines: widget.minLines.validate(value: widget.textFieldType == TextFieldType.MULTILINE ? 2 : 1),
